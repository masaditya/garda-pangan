...
export function VolunteerHeroSection() {
  return (
    <section className="relative overflow-hidden bg-garda-forest text-white h-screen min-h-[600px]">
      ...
      <div className="absolute inset-0 bg-[#0C381E] bg-cover bg-center bg-no-repeat mix-blend-multiply opacity-80" style={{ backgroundImage: "url('/garda-hero-reference.png')" }} />
      <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-white to-transparent" />
      
      <SectionShell spacing="hero" className="relative z-10 flex h-full flex-col items-center justify-center text-center">

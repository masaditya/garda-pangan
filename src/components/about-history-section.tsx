    ...
    <SectionShell tone="white">
      <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
        <div className="lg:col-span-5">
          <h2 className="text-4xl font-black tracking-tight text-garda-forest sm:text-5xl lg:sticky lg:top-32" dangerouslySetInnerHTML={{ __html: title.split(' ').join('<br class="hidden lg:block" /> ') }} />
        </div>
        <div className="space-y-8 text-lg leading-relaxed text-garda-ink-soft lg:col-span-7">
          ...
          <div className="relative mt-12 grid grid-cols-2 gap-4">
            {imageUrl ? (
              <img src={imageUrl} alt={title} className="aspect-square rounded-2xl object-cover bg-garda-paper/50" />
            ) : (
